...
def test_settings_load_supabase_configuration() -> None:
    ...
    assert settings.supabase_jwks_url == "https://test-project.supabase.co/auth/v1/.well-known/jwks.json"
    assert (
...
def test_jwt_helper_initialization_uses_settings_only() -> None:
    ...
    assert verifier.jwks_url == "https://test-project.supabase.co/auth/v1/.well-known/jwks.json"
